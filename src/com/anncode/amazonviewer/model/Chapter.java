...
public class Chapter extends Movie {
	...
	public void view() {
		// TODO Auto-generated method stub
                ...
                chapterViewedCounter = chapters.stream().filter((chapter) -> (chapter.getIsViewed())).map((_item) -> 1).reduce(chapterViewedCounter, Integer::sum);
